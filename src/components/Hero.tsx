  ...
  return (
    <section ref={container} className="section" style={{ borderBottom: '1px dashed var(--border)', minHeight: 'calc(100vh - 85px)', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'relative', overflow: 'hidden', padding: '0', perspective: '1000px' }}>
      ...
      <div className="parallax-bg" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100vw', height: '100vw', maxWidth: '1000px', maxHeight: '1000px', pointerEvents: 'none', zIndex: 0, transformStyle: 'preserve-3d' }}>
        ...
        {/* Core Glow */}
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%) translateZ(-100px)', width: '50%', height: '50%', background: 'radial-gradient(circle, color-mix(in srgb, var(--accent-alt) 15%, transparent) 0%, transparent 60%)', filter: 'blur(30px)' }}></div>
        
        {/* Radar Rings */}
        <div style={{ position: 'absolute', top: '10%', left: '10%', width: '80%', height: '80%', border: '1px solid color-mix(in srgb, var(--accent-alt) 10%, transparent)', borderRadius: '50%', transform: 'translateZ(-50px)' }}></div>
        <div style={{ position: 'absolute', top: '25%', left: '25%', width: '50%', height: '50%', border: '1px dashed color-mix(in srgb, var(--accent) 20%, transparent)', borderRadius: '50%', transform: 'translateZ(-25px)' }}></div>
        <div style={{ position: 'absolute', top: '38%', left: '38%', width: '24%', height: '24%', border: '1px dotted color-mix(in srgb, var(--fg) 20%, transparent)', borderRadius: '50%' }}></div>
        ...
        <div className="orbit-ring-1" style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', transformStyle: 'preserve-3d' }}>
          <div style={{ position: 'absolute', top: '10%', left: 'calc(50% - 6px)', transform: 'translateY(-50%) translateZ(20px)', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ background: 'color-mix(in srgb, var(--bg-surface) 60%, transparent)', backdropFilter: 'blur(4px)', border: '1px solid color-mix(in srgb, var(--accent-alt) 30%, transparent)', padding: '0.2rem 0.5rem', borderRadius: '4px', fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: 'var(--fg)', whiteSpace: 'nowrap' }}>MacBook Pro</div>
          </div>
        </div>
        ...
        <div className="orbit-ring-2" style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', transformStyle: 'preserve-3d' }}>
          <div style={{ position: 'absolute', top: '25%', left: 'calc(50% - 6px)', transform: 'translateY(-50%) translateZ(40px)', display: 'flex', alignItems: 'center', gap: '8px', flexDirection: 'row-reverse' }}>
            ...
            <div style={{ background: 'color-mix(in srgb, var(--bg-surface) 60%, transparent)', backdropFilter: 'blur(4px)', border: '1px solid color-mix(in srgb, var(--accent) 30%, transparent)', padding: '0.2rem 0.5rem', borderRadius: '4px', fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: 'var(--fg)', whiteSpace: 'nowrap' }}>Pixel 7</div>
          </div>
        </div>
        ...
        <div className="orbit-ring-3" style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', transformStyle: 'preserve-3d' }}>
          <div style={{ position: 'absolute', top: '38%', left: 'calc(50% - 4px)', transform: 'translateY(-50%) translateZ(60px)', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ background: 'color-mix(in srgb, var(--bg-surface) 60%, transparent)', backdropFilter: 'blur(4px)', border: '1px solid color-mix(in srgb, var(--fg) 20%, transparent)', padding: '0.2rem 0.5rem', borderRadius: '4px', fontFamily: 'var(--font-mono)', fontSize: '0.6rem', color: 'var(--fg)', whiteSpace: 'nowrap' }}>Win11 Desktop</div>
          </div>
        </div>
      </div>
      ...
      <div className="container parallax-fg" style={{ position: 'relative', zIndex: 10, maxWidth: '900px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="hero-reveal" style={{ display: 'inline-flex', alignItems: 'center', border: '1px solid color-mix(in srgb, var(--accent-alt) 30%, transparent)', padding: '0.35rem 1rem', borderRadius: '50px', marginBottom: '2rem', background: 'color-mix(in srgb, var(--bg-surface) 80%, transparent)', backdropFilter: 'blur(8px)' }}>
        ...
        <div className="hero-terminal-card" style={{ marginTop: '3rem', width: '100%', maxWidth: '700px', background: 'color-mix(in srgb, var(--bg-surface) 40%, transparent)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid color-mix(in srgb, var(--accent-alt) 20%, transparent)', borderRadius: '12px', padding: '1.5rem', textAlign: 'left', boxShadow: '0 20px 40px color-mix(in srgb, var(--fg) 10%, transparent)', position: 'relative' }}>
